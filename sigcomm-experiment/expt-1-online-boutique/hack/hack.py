...
replaceServiceAddr('./manifests/knative/frontend.yaml', ingress)
replaceServiceAddr('./manifests/knative/checkoutservice.yaml', ingress)
replaceServiceAddr('./manifests/knative/recommendationservice.yaml', ingress)