...
.PHONY: all io shmmgr gateway node clean

all: lib io shmmgr gateway node

io: lib/io_rte_ring.a lib/io_sk_msg.a
...
lib/io_rte_ring.a: src/io_rte_ring.o
	@ echo "AR $@"
	@ ar -rcs $@ $^

lib/io_sk_msg.a: src/io_sk_msg.o
	@ echo "AR $@"
	@ ar -rcs $@ $^
