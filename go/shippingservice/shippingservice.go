...
func (s *server) GetQuote(in *pb.GetQuoteRequest) (*pb.GetQuoteResponse, error) {
...
func (s *server) ShipOrder(in *pb.ShipOrderRequest) (*pb.ShipOrderResponse, error) {
